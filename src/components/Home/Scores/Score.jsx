            ...
            <div className=' w-full h-full  flex flex-col items-center mt-4'>
                ...
                <div className='w-full h-full flex flex-row justify-around'>
                    <div className='w-full h-full flex flex-col justify-center items-center'>
                        ...
                        <h5 className=' font-bold header mt-4 text-center text-[14px] text-white uppercase  custom-shadow-text'>{score.team1}</h5>
                    </div>

                    <div className='flex flex-col items-center justify-center h-full'>
                        <div className='flex flex-row justify-center items-center'>
                            <h5 className='text-[18px] font-bold header text-white uppercase  custom-shadow-text'>{score.score1}</h5>
                            <h5 className='text-[18px] font-bold header text-white uppercase ml-2  custom-shadow-text'>-</h5>
                            <h5 className='text-[18px] font-bold header text-white uppercase ml-2  custom-shadow-text'>{score.score2}</h5>
                        </div>
                        <h5 className='text-[18px] font-bold header text-white uppercase  custom-shadow-text'>VS</h5>
                    </div>
